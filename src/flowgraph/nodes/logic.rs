...
use crate::flowgraph::node::{
 get_required_bool, ExecFireSet, InputMap, NodeDescriptor, NodeExecError, NodeOutput, NodeSpec, PortSpec,
 PureNode,
};
...
mod tests {
 ...
 fn bool_inputs(a: bool, b: bool) -> InputMap {
  [("a".into(), SocketValue::Bool(a)), ("b".into(), SocketValue::Bool(b))].into_iter().collect()
 }

 #[tokio::test]
 async fn and_truth_table() {
  let n = AndNode;
  for (a, b, ex) in [(true, true, true), (true, false, false), (false, true, false), (false, false, false)] {
