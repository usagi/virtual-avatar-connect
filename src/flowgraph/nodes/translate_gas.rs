...
use crate::flowgraph::node::{
 get_optional_string, get_required_string, EffectfulNode, ExecCtx, ExecFireSet, InputMap, NodeDescriptor,
...
const URL_TEMPLATE: &str =
 "https://script.google.com/macros/s/{script_id}/exec?trans_sourcelang={from}&target={to}&text={text}";
 ...
 fn describe(&self) -> NodeSpec {
  NodeSpec {
   ...
   inputs: vec![
    ...
    PortSpec::input("translate_from", "Translate From", SocketType::String)
