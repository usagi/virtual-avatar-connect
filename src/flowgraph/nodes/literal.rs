...
literal_node!(BoolLiteralNode, "flowgraph.literal.bool", "Bool Literal", SocketType::Bool, SocketValue::Bool(false));
literal_node!(IntLiteralNode, "flowgraph.literal.int", "Int Literal", SocketType::Int, SocketValue::Int(0));
literal_node!(FloatLiteralNode, "flowgraph.literal.float", "Float Literal", SocketType::Float, SocketValue::Float(0.0));
literal_node!(StringLiteralNode, "flowgraph.literal.string", "String Literal", SocketType::String, SocketValue::String(String::new()));
literal_node!(JsonLiteralNode, "flowgraph.literal.json", "JSON Literal", SocketType::Json, SocketValue::Json(serde_json::Value::Null));
