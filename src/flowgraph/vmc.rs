...
//! - **受信**: [`MotionFrame`](crate::motion::MotionFrame) 内の上記アドレスを [`try_parse_ext_pos_message`] で構造化（ingress は `vmc_udp` + `vmc_parse`）。
...
mod tests {
	use super::*;
	use crate::motion::OscMessageWire;
