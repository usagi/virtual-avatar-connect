...
export type VmcPassthroughBindState =
  | "configured"
  | "skipped"
  | "running"
  | "failed"
...
export type FlowgraphEffectClass =
  | "pure"
  | "stateful"
  | "effectful"
  | "unknown";
...
export type FlowgraphPackageLockEntry = {
  id: string;
  version?: string;
  source_fq: string;
  source_digest: string;
...
export type FlowgraphSaveLiveStateSnapshotResponse = {
  path: string;
  snapshot_node_count: number;
  written: boolean;
};
