...
virtual-avatar-connect/
  Cargo.toml
  crates/
    vac-core/          # conf, runtime paths, shutdown, shared state primitives（現状は shutdown + runtime paths + DateTime + utility + resource constants + Twitch OAuth sessions + ControlEvent）
